...
import com.xl.xim.client.handle.MsgHandleCaller;
import com.xl.xim.client.service.impl.MsgCallBackListener;
...
public class BeanConfig {
    ...
    @Value("${xim.callback.thread.queue.size}")
    private int queueSize;

    @Value("${xim.callback.thread.pool.size}")
